...
public class AvroSplittableInputFormatTest {
	...
	public void createFiles() throws IOException {
		...
		user1.setTypeTimestampMillis(OffsetDateTime.parse("2014-03-01T12:12:12.321Z").toInstant());
		user1.setTypeTimestampMicros(ChronoUnit.MICROS.addTo(Instant.ofEpochMilli(0), 123456L));
		// 20.00
		...
		for (int i = 0; i < NUM_RECORDS - 2; i++) {
			...
			user.setTypeTimestampMillis(OffsetDateTime.parse("2014-03-01T12:12:12.321Z").toInstant());
			user.setTypeTimestampMicros(ChronoUnit.MICROS.addTo(Instant.ofEpochMilli(0), 123456L));
			// 20.00
